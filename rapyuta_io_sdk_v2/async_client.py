...
class AsyncClient:
    ...
    async def get_backup(self, guid: str, **kwargs) -> Backup:
    ...
    async def create_backup(self, body: Backup | dict[str, Any], **kwargs) -> Backup:
        """Create a new backup.
    ...
    async def delete_backup(self, guid: str, **kwargs) -> None:
